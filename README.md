...
## Notice:
- The frame has to cut from a 3mm steel sheet. It's not possible to assemble the frame if it has not the right tickness (repetita iuvant: 3mm steel sheet!).
- All the parts of the frame in the design should be re-positioned by the one who will work with the laser cutter. Let him do that job!
- The one who works with the laser cutter probably will ask you the .DWG format.
